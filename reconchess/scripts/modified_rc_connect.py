...
def listen_for_invitations(server, bot_cls, max_concurrent_games, limit_games):
    connected = False
...
def main():
    ...
    parser.add_argument('--limit-games', type=int, default=None, help='Optional limit to number of games played.')
    ...
    listen_for_invitations(server, bot_cls, args.max_concurrent_games, args.limit_games)
