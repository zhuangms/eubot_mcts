...
import defaults
from strategies.auxiliary_strategies import contingency_strategy
from utilities import board_matches_sense, move_would_happen_on_board, populate_next_board_set
from utilities.player_logging import create_main_logger
from utilities.timing import Timer

from multiprocessing_strategies import create_strategy
...
class StrangeFish(Player):
    ...
    def __init__(
        ...
        self._choose_sense, self._choose_move, self._while_we_wait, self._end_game = create_strategy()
